...
public class JNIWrapper {
	...
	static {
		...
		//   java.library.path=/path/to/clib_jniwrapper.dll
        //System.loadLibrary("clib_jniwrapper");
		...
		if (osName.indexOf("Windows") != -1) {
			...
			System.load(JNIWrapper.concatPaths(jniLibsPrefix, "libclib_dll.dll"));
			System.load(JNIWrapper.concatPaths(jniLibsPrefix, "clib_jniwrapper.dll"));
    ...
    public native void JNI_clib_lib_version();


    public static void main(String[] args) {
        JNIWrapper jniCall = new JNIWrapper();

		jniCall.JNI_clib_lib_version();
    }
}